"""
Test utilities and common setup for Holdem CLI tests.

This module provides standardized test setup functionality to ensure
consistent import path handling across all test files.
"""
